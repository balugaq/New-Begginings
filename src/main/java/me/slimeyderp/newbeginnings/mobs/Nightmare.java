...
public class Nightmare {
    ...
    public static void createNightmare(Location l) {
        ...
        nightmareAtributtable.getAttribute(Attribute.GENERIC_ATTACK_DAMAGE).setBaseValue(15);
        nightmareAtributtable.getAttribute(Attribute.GENERIC_ARMOR).setBaseValue(6);
